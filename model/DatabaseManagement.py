...
class DatabaseManagement:
    def __init__(self):
        ...
        self.user = 'root'
        self.password = ''
        self.db_name = 'facerecognitionsystems'
    ...
    # 6.1.15. DatabaseManagement thực hiện truy vấn đến cơ sở dữ liệu để lấy danh sách học sinh có điểm danh (Database).
    def get_attendance_data(self):
        ...
        # 6.1.16. Cơ sở dữ liệu (Database) trả về danh sách học sinh có điểm danh (bao gồm tên lớp, ID, tên học sinh, buổi học, ngày) cho AttendanceWindow
        return result if result else []

    # 6.1.22. DatabaseManagement thực hiện truy vấn đến cơ sở dữ liệu để lấy danh sách học sinh vắng (Database).
    def get_no_attendance_data(self):
        ...
        """
        result = self.execute_query(query, fetch=True)
    # 6.1.23. Cơ sở dữ liệu (Database) trả về danh sách học sinh vắng (bao gồm tên lớp, ID, tên học sinh, buổi học, ngày) cho NoAttendanceWindow
        return result if result else []

    # 6.1.7. DatabaseManagement thực hiện truy vấn đến cơ sở dữ liệu (Database) để lấy danh sách lớp, số học sinh có điểm danh và số học sinh vắng
    def get_class_statistics(self):
        ...
        # 6.1.8. Cơ sở dữ liệu (Database) trả về dữ liệu thống kê (danh sách lớp, số học sinh có điểm danh, số học sinh vắng) cho DatabaseManagement.
